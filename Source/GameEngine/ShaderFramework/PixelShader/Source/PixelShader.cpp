...
void SpaceGameEngine::PixelShader::InitFromFile(ID3D11Device * pDevice, LPCWSTR filename, const String & includefilename, const String & entryname, D3D_SHADER_MACRO * macros)
{
	if (pDevice == nullptr)
	{
		ThrowError(L"指针不能为空");
